...
| 方案 | 特点 | 结论 |
|------|------|------|
| VMware vCenter Converter Standalone | 官方免费工具，自动处理驱动兼容性和虚拟硬件版本 | 最稳，推荐 |
| OVF / OVA 导出导入 | ESXi 自带功能，但虚拟硬件版本可能与 Workstation 不兼容 | 可用，但常需手动改 `.ovf` |
| 直接拷贝 VMDK | 格式不完全一致，风险较高 | 不推荐 |
