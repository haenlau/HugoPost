...
date = "2026-07-15T06:17:51+00:00"
...
title = "浏览器有限制端口这件事"
url = "/browser-restricted-ports-10080/"
date = "2026-07-15T06:03:40+00:00"
description = "随手用了 10080 端口测试 Web 服务，死活打不开，排查了半天发现是浏览器内置的黑名单。"
tags = [
  "技术",
  "踩坑",
...
![浏览器报错截图](/tmp/wechat_imgs_original/wechat_01.png)

把端口改成 18080 后，网页立刻恢复正常。

![Firefox 报错](/tmp/wechat_imgs_original/wechat_05.png)

![curl 测试正常](/tmp/wechat_imgs_original/wechat_02.png)

---

## 浏览器有限制端口这件事

![受限端口列表](/tmp/wechat_imgs_original/wechat_06.png)
